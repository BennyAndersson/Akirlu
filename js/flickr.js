...
document.getElementById("reset").addEventListener("click", function () {
    const meddelanden = [
        "Klicka inte här din dumme fan!!!",
        "Hallåååååååå !! Ville du inte ha bilen eller??!",
        "Om man är naken när man duschar så är man bäst!!!!"
    ];

    const randomMeddelande =
        meddelanden[Math.floor(Math.random() * meddelanden.length)];

    alert(randomMeddelande);
     location.reload();
});  
